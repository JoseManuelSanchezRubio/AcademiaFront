        ...
        <div className="border-start h-100">
            ...
            <div>{props.professorId && (
                <div><button type="button" className="btn btn-primary ms-4" data-bs-toggle="modal" data-bs-target="#addAnnouncement">
                    ...
                    <div className="modal fade" id="addAnnouncement" tabIndex="-1" aria-labelledby="modal" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h1 className="modal-title fs-5" id="modal">Nuevo anuncio</h1>
                                ...
                                <div className="modal-body">
                                    <form>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="title-modal" onChange={(e) => setTitle(e.target.value)} />
                                        </div>
                                        <div className="mb-3">
                                            <label htmlFor="body-modal" className="form-label">Descripción</label>
                                            <textarea id="body-modal" cols="30" rows="3" className="form-control" onChange={(e) => setBody(e.target.value)}></textarea>
                                        </div>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="button" className="btn btn-primary" onClick={(e) => addAnnouncement(e)}>Enviar</button>
                                </div>
                            </div>
                        </div>
                    </div></div>
